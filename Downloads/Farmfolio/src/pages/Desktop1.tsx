...
const Desktop1: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[7878px] overflow-hidden text-left text-xl text-black font-roboto">
      ...
      <SectionCard1 />
      <section
        className="absolute top-[0px] left-[0px] bg-whitesmoke w-[878px] h-[110px] overflow-hidden text-left text-13xl text-black font-roboto"
        id="header"
      >
      ...
      <section className="absolute top-[793px] left-[0px] bg-whitesmoke w-[1440px] h-[400px] overflow-hidden text-left text-5xl text-black font-roboto">
      ...
      <EasyToUseContainer
        ...
        propWidth="339px"
      />
      <section className="absolute top-[3600px] left-[0px] bg-gray-200 w-[1440px] h-[630px] overflow-hidden text-left text-33xl text-white font-roboto">
      ...
      />
      <SectionCard2 />
      <div className="absolute top-[4878px] left-[452px] w-[589px] h-[50px] overflow-hidden text-23xl">
      ...
      <div className="absolute top-[5064px] left-[200px] rounded-xl bg-whitesmoke w-[310px] h-[350px] overflow-hidden">
        <img
      ...
      <div className="absolute top-[5064px] left-[565px] rounded-xl bg-whitesmoke w-[310px] h-[350px] overflow-hidden">
        <img
          className="absolute top-[40px] left-[40px] w-[97px] h-[19px] object-cover"
          alt=""
          src="/image-4@2x.png"
      ...
      <div className="absolute top-[5064px] left-[930px] rounded-xl bg-whitesmoke w-[310px] h-[350px] overflow-hidden">
        <img
          className="absolute top-[40px] left-[40px] w-[97px] h-[19px] object-cover"
          alt=""
          src="/image-4@2x.png"
