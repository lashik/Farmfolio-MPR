...
const SectionCardForm: FunctionComponent = () => {
  return (
    <section className="absolute top-[7100px] left-[0px] bg-gray-200 w-[1440px] h-[400px] overflow-hidden text-left text-33xl text-white font-roboto">
      <Button
        className="absolute top-[257px] left-[497px] bg-opacity-60 bg-gray-400 text-white border-0"
        sx={{ width: 208 }}
        color="primary"
        variant="contained"
      >
      ...
      <BsButton
        className="w-52 absolute top-[257px] left-[735px] bg-opacity-60 bg-gray-400 text-white border-0"
        variant="primary"
      >
        Contact Sales
      </BsButton>
