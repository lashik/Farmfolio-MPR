...
const SectionCard1: FunctionComponent = () => {
  return (
    <section className="absolute top-[0px] left-[2px] bg-whitesmoke w-[900px] h-[800px] overflow-hidden text-left text-33xl text-black font-roboto">
      ...
      <Button
        className="w-[410px] absolute top-[552px] left-[200px] bg-black text-white border-0"
        variant="primary"
      >{`Get Started `}</Button>
    </section>
  );
