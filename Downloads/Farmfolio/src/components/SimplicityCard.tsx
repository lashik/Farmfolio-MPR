...
const SimplicityCard: FunctionComponent = () => {
  return (
    <section className="absolute top-[2036px] left-[-1px] w-[1440px] h-[732px] overflow-hidden text-left text-xl text-black font-roboto">
      <div className="absolute top-[149px] left-[79px] w-[689px] h-[433px] overflow-hidden">
        ...
        <Button
          className="w-[215px] absolute top-[377px] left-[117px] bg-black text-white border-0"
          variant="primary"
        >
          Learn More
        </Button>
      </div>
      <div className="absolute top-[194px] left-[771px] rounded-xl bg-whitesmoke w-[470px] h-[340px] overflow-hidden">
        <img
