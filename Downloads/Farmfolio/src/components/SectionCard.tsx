...
const SectionCard: FunctionComponent = () => {
  return (
    <section className="absolute top-[6300px] left-[0px] bg-whitesmoke w-[1440px] h-[800px] overflow-hidden text-left text-23xl text-black font-roboto">
      ...
      <Button
        className="w-[272px] absolute top-[477px] left-[200px] bg-black text-white border-0"
        variant="primary"
      >
        Connect tools
      </Button>
