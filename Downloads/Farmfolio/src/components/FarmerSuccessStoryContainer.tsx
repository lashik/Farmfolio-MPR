...
type FarmerSuccessStoryContainerType = {
  howAFarmerFromNashikGrew1?: string;
  modernFarmingMethodsHaveO?: string;
  yeilding1?: string;
  ...
  /** Action props */
  onReadMoreTextClick?: () => void;
};

const FarmerSuccessStoryContainer: FunctionComponent<
  FarmerSuccessStoryContainerType
> = ({
  ...
  const modernFarmingMethodsStyle: CSSProperties = useMemo(() => {
    return {
  ...
  return (
    ...
    >
      <div className="absolute top-[146px] left-[0px] bg-whitesmoke w-[310px] h-[304px] overflow-hidden">
        <div
