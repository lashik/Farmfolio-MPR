...
const EmailFormSection: FunctionComponent = () => {
  return (
    <section className="absolute top-[7500px] left-[1px] bg-whitesmoke w-[1440px] h-[378px] overflow-hidden text-left text-sm text-black font-roboto">
      ...
      <Button
        className="w-[272px] absolute top-[29px] left-[1150px] bg-black text-white border-0"
        variant="primary"
      >
        Subscribe Now
      </Button>
